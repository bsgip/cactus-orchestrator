...
VALUES
(1, 'user-1-device-1', 'v1.2', TRUE, '\x01', '2023-01-01T00:01:00Z', 11, FALSE),
(1, 'user-1-device-2', 'v1.3-beta/storage', NULL, NULL, NULL, 0, TRUE),
(2, 'user-2-device-1', 'v1.2', TRUE, '\x01', '2023-01-01T00:01:00Z', 11, FALSE),
