...
VALUES ('user1', 'https://test-cactus-issuer.example.com', E'\\x', E'\\x', E'\\x', E'\\x');
INSERT INTO user_ (subject_id, issuer_id, aggregator_certificate_p12_bundle, aggregator_certificate_x509_der, device_certificate_p12_bundle, device_certificate_x509_der)
VALUES ('user2', 'https://test-cactus-issuer.example.com', E'\\x', E'\\x', E'\\x', E'\\x');
INSERT INTO user_ (subject_id, issuer_id, aggregator_certificate_p12_bundle, aggregator_certificate_x509_der, device_certificate_p12_bundle, device_certificate_x509_der)
...
INSERT INTO run (run_group_id, teststack_id, testprocedure_id, finalised_at, run_status, all_criteria_met)
VALUES 
(1, 'teststack1', 'ALL-01', NULL, 1, NULL), -- run_id 1
(1, 'teststack2', 'ALL-01', '2024-01-02T00:02:00Z', 3, TRUE), -- run_id 2
(1, 'teststack3', 'ALL-02', '2024-01-02T00:03:00Z', 4, TRUE), -- run_id 3
