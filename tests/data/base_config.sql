...
VALUES 
(1, 'run-1', 'ALL-01', '2024-01-01T00:01:00Z', NULL, 1, NULL), -- run_id 1
(1, 'run-2', 'ALL-01', '2024-01-01T00:02:00Z', '2024-01-02T00:02:00Z', 3, TRUE), -- run_id 2
(1, 'run-3', 'ALL-02', '2024-01-01T00:03:00Z', '2024-01-02T00:03:00Z', 4, TRUE), -- run_id 3
(1, 'run-4', 'ALL-03', '2024-01-01T00:04:00Z', '2024-01-02T00:04:00Z', 5, FALSE), -- run_id 4
(2, 'run-5', 'ALL-01', '2024-01-01T00:05:00Z', NULL, 2, NULL), -- run_id 5
(3, 'run-6', 'GEN-02', '2024-01-01T00:06:00Z', NULL, 1, NULL), -- run_id 6
(1, 'run-7', 'ALL-04', '2024-01-01T00:07:00Z', '2024-01-02T00:07:00Z', 3, FALSE), -- run_id 7
(1, 'run-8', 'ALL-05', '2024-01-01T00:08:00Z', NULL, 2, NULL); -- run_id 8
