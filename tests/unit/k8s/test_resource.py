...
from cactus_orchestrator.settings import DEFAULT_INGRESS_PATH_FORMAT, CactusOrchestratorError
    ...
    mock_statefulset = client.V1StatefulSet(
        ...
        spec=client.V1StatefulSetSpec(
            ...
            template=client.V1PodTemplateSpec(
                ...
                spec=client.V1PodSpec(containers=[container_foo, container_envoy, container_bar]),
            ),
        ),
    )
    template_resource_names = generate_class_instance(TemplateResourceNames, seed=101)
