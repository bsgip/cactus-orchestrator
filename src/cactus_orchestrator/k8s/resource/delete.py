...
async def delete_service(run_resource_names: RunResourceNames) -> None:
    res: ApplyResult = v1_core_api.delete_namespaced_service(  # ty: ignore[invalid-assignment]
        run_resource_names.service,
        namespace=run_resource_names.namespace,
...
async def delete_statefulset(run_resource_names: RunResourceNames) -> None:
    res: ApplyResult = v1_app_api.delete_namespaced_stateful_set(  # ty: ignore[invalid-assignment]
        run_resource_names.stateful_set,
        namespace=run_resource_names.namespace,
        async_req=True,  # ty: ignore[unknown-argument]
    )
