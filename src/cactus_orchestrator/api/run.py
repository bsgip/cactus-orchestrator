...
async def finalise_run(
    ...
    if file_data:
        ...
        # The file_data is a zip archive containing the pdf run report generated by the runner.
        # Generate a new pdf run report here in the orchestrator and replace the runner-generated report
