...
async def create_compliance_request(
    ...
    request = await insert_compliance_request(
        ...
        cactus_version=body.cactus_version,
        ...
        der_cec_listed_models=body.der_cec_listed_models,
        der_unlisted_models=body.der_unlisted_models,
        der_white_labelled_models=body.der_white_labelled_models,
        software_client_type=body.software_client_type,
        software_client_name=body.software_client_name,
