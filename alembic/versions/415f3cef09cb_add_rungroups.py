...
down_revision: str | None = "5b8e7f27f1cf"
...
def upgrade() -> None:
    ...
    op.create_index("run_group_user_id_idx", "run_group", ["user_id", "id"], unique=False)
    # ### end Alembic commands ###


def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index("run_group_user_id_idx", table_name="run_group")
